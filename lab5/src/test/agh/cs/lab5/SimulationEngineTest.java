...
class SimulationEngineTest {
    ...
    IWorldMap map1 = new RectangularMap(6,4,new ArrayList<>());
    ...
    IWorldMap map2 = new RectangularMap(5,3,new ArrayList<>());
    ...
    IWorldMap map3 = new RectangularMap(4,8,new ArrayList<>());
    ...
    IWorldMap map5 = new RectangularMap(7,10,new ArrayList<>());
    ...
    IWorldMap map6 = new RectangularMap(5,5,new ArrayList<>());
    ...
    void testRun(){
        ...
        IWorldMap map1test = new RectangularMap(6,4,new ArrayList<>());
        IWorldMap map2test = new RectangularMap(5,3,new ArrayList<>());
        IWorldMap map3test = new RectangularMap(4,8,new ArrayList<>());
        IWorldMap map4test = new RectangularMap(7,9,new ArrayList<>());
        IWorldMap map5test = new RectangularMap(7,10,new ArrayList<>());
        IWorldMap map6test = new RectangularMap(5,5,new ArrayList<>());
