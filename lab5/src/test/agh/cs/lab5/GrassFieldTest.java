...
class GrassFieldTest{
    // Testowe pola traw
    GrassField field1 = new GrassField(10,new ArrayList<>());
    GrassField field2 = new GrassField(20,new ArrayList<>());
    GrassField field3 = new GrassField(50,new ArrayList<>());
    GrassField field4 = new GrassField(25,new ArrayList<>());
    GrassField field5 = new GrassField(43,new ArrayList<>());
    ...
    @Test
    void testToString() {
        GrassField testfield1 = new GrassField(10,new ArrayList<>());
        GrassField testfield2 = new GrassField(55,new ArrayList<>());
        GrassField testfield3 = new GrassField(50,new ArrayList<>());
        GrassField testfield4 = new GrassField(25,new ArrayList<>());
        GrassField testfield5 = new GrassField(19,new ArrayList<>());
        GrassField testfield6 = new GrassField(100,new ArrayList<>());
        GrassField testfield7 = new GrassField(0,new ArrayList<>());

        animal at1 = new animal(testfield2,new Vector2d(5,3));
        animal at2 = new animal(testfield4,new Vector2d(4,1));
        animal at3 = new animal(testfield7,new Vector2d(1,0));
        ...
        assertEquals(testfield7.toString(), testfield7.toString());
        testfield7.place(at3);
        assertNotEquals(testfield5.toString(), testfield7.toString());
        assertNotEquals(testfield2.toString(), testfield7.toString());
        field2.place(a8);
        assertNotEquals(testfield2.toString(), testfield7.toString());
