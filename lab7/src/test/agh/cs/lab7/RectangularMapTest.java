...
class RectangularMapTest{
    //Mapy testowe
    IWorldMap map1 = new RectangularMap(5,10, new HashMap<>());
    IWorldMap map2 = new RectangularMap(15,5, new HashMap<>());
    IWorldMap map3 = new RectangularMap(4,1, new HashMap<>());
    IWorldMap map4 = new RectangularMap(7,9, new HashMap<>());
    IWorldMap map5 = new RectangularMap(4,12, new HashMap<>());
    ...
    animal a15 = new animal(map4,new Vector2d(-7,7));
    ...
    void testCanMoveTo(){
        ...
        map1.place(a1);
        assertThrows(IllegalArgumentException.class, () -> map1.place(a2));
        map1.place(a3);
        map1.place(a4);
        ...
        map2.place(a5);
        assertThrows(IllegalArgumentException.class, () -> map2.place(a6));
        map2.place(a7);
        map2.place(a8);
        ...
        assertThrows(IllegalArgumentException.class, () -> map3.place(a9));
        map3.place(a10);
        map3.place(a11);
        assertThrows(IllegalArgumentException.class, () -> map3.place(a12));
        ...
        map4.place(a13);
        map4.place(a14);
        assertThrows(IllegalArgumentException.class, () -> map4.place(a16));
    ...
    void testPlace(){
        ...
        assertThrows(IllegalArgumentException.class, () -> map4.place(a15));
        assertThrows(IllegalArgumentException.class, () -> map4.place(a16));

        assertTrue(map5.place(a17));
        assertThrows(IllegalArgumentException.class, () -> map5.place(a18));
        assertTrue(map5.place(a19));
        assertThrows(IllegalArgumentException.class, () -> map5.place(a20));
    }
    ...
    void testToString() {
        ...
        IWorldMap map1test = new RectangularMap(5,10, new HashMap<>());
        IWorldMap map2test = new RectangularMap(15,5, new HashMap<>());
        IWorldMap map3test = new RectangularMap(4,1, new HashMap<>());
        IWorldMap map4test = new RectangularMap(7,9, new HashMap<>());
        IWorldMap map5test = new RectangularMap(4,12, new HashMap<>());
